...
mod tests {
    ...
    #[test]
    fn test_extract_gnu_attributes_from_function_definition() {
        let code = r#"
            __attribute__((warn_unused_result, nonnull(1)))
            int load_worker(const char *name) {
                return name != 0;
            }
        "#;
        ...
        assert_eq!(annotation_keys, vec!["warn_unused_result", "nonnull"]);
    }
}
