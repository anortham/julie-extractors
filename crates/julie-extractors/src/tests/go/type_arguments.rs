...
const FIXTURE_SOURCE: &str = include_str!("../../../../../fixtures/extraction/go/basic/source.go");
...
fn extract_fixture(source: &str) -> crate::ExtractionResults {
    ...
    .expect("canonical Go extraction should succeed")
}
...
fn basic_fixture_emits_nested_type_arguments_via_canonical_pipeline() {
    ...
    assert_eq!(
        ...
        1,
        "fixture should emit one Map[string, List[int]] usage, got {:?}",
