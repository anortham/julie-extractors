...
pub(super) const SPECS: &[StructuralFactPatternSpec] = &[
    StructuralFactPatternSpec {
        ...
        metadata_keys: &[
            ...
            key(
                ...
                STR,
                OPT,
                "Controller action target when statically resolvable: \"Ctrl@method\" from [Ctrl::class, 'method'], \"Ctrl@__invoke\" for an invokable Ctrl::class, or the action string joined to a same-file Route::controller group.",
            ),
            key(
                "route_name",
                STR,
                OPT,
                "Static ->name('x') on the route, prefixed by any same-file group ->name()/as prefix.",
            ),
        ],
    },
    StructuralFactPatternSpec {
    ...
    StructuralFactPatternSpec {
        ...
        languages: &["php"],
        query_family: "framework",
        description: "A static Laravel Route::prefix()/group(['prefix'=>...]) prefix at its definition site, including a group that loads a route file.",
        metadata_keys: &[
            K_PATTERN_VERSION,
            K_QUERY_FAMILY,
            K_FRAMEWORK,
            ...
            key(
                ...
                STR,
                OPT,
                "Route file a group loads (base_path('routes/api.php') or __DIR__ . '/...'); code-kb joins it across files.",
            ),
        ],
    },
    StructuralFactPatternSpec {
        ...
        metadata_keys: &[
            ...
            key(
                ...
                STR,
                OPT,
                "Static name: of the method #[Route], prefixed by the class-level #[Route] name:.",
            ),
        ],
    },
];
