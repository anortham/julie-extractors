...
pub(super) const SPECS: &[StructuralFactPatternSpec] = &[
    ...
    StructuralFactPatternSpec {
        pattern_id: "html.resource_link.v1",
        languages: &["html"],
        query_family: "document_assets",
        description: "An HTML `<link>` element with an href.",
        metadata_keys: &[
            K_PATTERN_VERSION,
            K_QUERY_FAMILY,
            key(
                ...
                STR,
                ALWAYS,
                "The link target from the href attribute.",
            ),
            key(
                "rel",
                STR,
                OPT,
                "The rel attribute token list, when present.",
            ),
            key(
                "as",
                STR,
                OPT,
                "The preload destination (`as`), when present.",
            ),
            key("type", STR, OPT, "The MIME type attribute, when present."),
        ],
    },
    StructuralFactPatternSpec {
        pattern_id: "html.embed.v1",
        languages: &["html"],
        query_family: "document_assets",
        description: "An embedded document or object (`<iframe>`, `<embed>`, `<object>`).",
        metadata_keys: &[
            K_PATTERN_VERSION,
            K_QUERY_FAMILY,
            key(
                ...
                STR,
                ALWAYS,
                "Embedding element tag name (iframe/embed/object).",
            ),
            key(
                "src",
                STR,
                ALWAYS,
                "Embedded resource URL (src, or data for object).",
            ),
            key("type", STR, OPT, "The MIME type attribute, when present."),
            key("title", STR, OPT, "The title attribute, when present."),
        ],
    },
    StructuralFactPatternSpec {
