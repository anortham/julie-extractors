...
The store implementation was published in v2.31.0 and patched through v2.37.1.
Version 2.37.1 is the current published release. Historical notes remain in
