...
The store implementation was published in v2.31.0 and patched through v2.35.0.
Version 2.35.0 is the current published release. Historical notes remain in
