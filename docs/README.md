...
The store implementation was published in v2.31.0 and patched through v2.37.0.
Version 2.37.0 is the current published release. Historical notes remain in
