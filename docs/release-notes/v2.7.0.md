...
Tag-triggered `Release Binaries` workflow run
[`28611572919`](https://github.com/anortham/julie-extractors/actions/runs/28611572919)
published GitHub release
[`v2.7.0`](https://github.com/anortham/julie-extractors/releases/tag/v2.7.0)
(non-draft, non-prerelease) at commit
`09e512139916e4e7d15d1aa1ae5a2deb0f182796` on `2026-07-02T18:17:31Z`.

| Target | Asset | SHA-256 |
| --- | --- | --- |
| Linux x86_64 | `julie-extract-v2.7.0-x86_64-unknown-linux-gnu.tar.gz` | `7433e9c36ab267a5c6e88b0c46f09eb1eba399fb1bd08b17f28a9ca79350d5ad` |
| macOS Apple Silicon | `julie-extract-v2.7.0-aarch64-apple-darwin.tar.gz` | `a379add4b9e30e2850e35cfd77d0801837362cf5e3db19e44b0a1f8e0fe302b9` |
| macOS Intel | `julie-extract-v2.7.0-x86_64-apple-darwin.tar.gz` | `fefb5f9d8b604e1b218350d6ac60236fe0fcebc11e6e6650545e1293e6f3dc9b` |
| Windows x86_64 | `julie-extract-v2.7.0-x86_64-pc-windows-msvc.zip` | `f2959e9a24b6e6a8ed49d2d377dc612346589ebf6b095e2602a0cd5c5c03bd93` |

Full published-asset verification, downloaded-binary dogfood metrics, and the
command log are in `docs/release-evidence/2026-07-02-v2-7-0-release.md`.
