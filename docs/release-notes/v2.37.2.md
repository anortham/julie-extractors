...
The stable release was published on 2026-08-27 at
<https://github.com/anortham/julie-extractors/releases/tag/v2.37.2> from source
commit `4e119046d0ca0ffe997432ca4663f650903023a5` on `main`. Candidate CI
[run 33078708496](https://github.com/anortham/julie-extractors/actions/runs/33078708496)
and release workflow
[run 33078709579](https://github.com/anortham/julie-extractors/actions/runs/33078709579)
passed. The four live asset names, sizes, and SHA-256 digests are recorded in
`docs/release-evidence/2026-08-27-v2-37-2-release.md`. This is the current
published release.
