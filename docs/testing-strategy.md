...
[the Go module manifest support record](languages/gomod.md). For `go.sum`
checksum files, `cargo xtask test language gosum` is the target. See
[the Go checksum support record](languages/gosum.md).
